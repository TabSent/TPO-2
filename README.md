...
Действия:
Проверка отображения логотипа (косвенная проверка успешной авторизации)
Примечание: Название теста не совсем соответствует проверке (фактически проверяется авторизация)
...
Особенность: Включает cleanup после проверки
...
Особенность: Использует Java-сортировку для верификации
